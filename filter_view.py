...
class RangeFilter(QObject):
    ...
    def __init__(self, filter: str, i: int, layout: QGridLayout, parent: QWidget | None=None):
        super().__init__(parent)
        self.checkbox = QCheckBox(filter, parent)
        _ = self.checkbox.checkStateChanged.connect(self.check_changed)
...
class FilterView(QGroupBox):
    _range_filters: dict[str, RangeFilter] = dict()
